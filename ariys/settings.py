"""
Django settings for ariys project.
...
SECRET_KEY = "django-insecure-ndiw#_@*0)k*h+48iwh7u=4zn6tz8cr9iyn(0!s@2cw3ua^vy4"
...
WSGI_APPLICATION = "ariys.wsgi.application"
...
default_db_config = {
    ...
    "NAME": env("DATABASE_NAME", "ariys"),
    "USER": env("DATABASE_USER", "ariys"),
    "PASSWORD": env("DATABASE_PASSWORD", "ariys"),
